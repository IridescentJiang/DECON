...
class UNetMidBlock3DCrossAttn(nn.Module):
    def __init__(
        ...
        for _ in range(num_layers): # Midblock只有一层Transformer3DModel
...
class CrossAttnDownBlock3D(nn.Module):
    def __init__(
        ...
        for i in range(num_layers): # 2层*(Resnet + Transformer) 
        ...
        for i, (resnet, attn, motion_module) in enumerate(
            ...
            if self.training and self.gradient_checkpointing:
                ...
                hidden_states = attn(
                    hidden_states,
                    encoder_hidden_states=encoder_hidden_states,
                ).sample # tensor float16 b c f h w 
...
class DownBlock3D(nn.Module):
    ...
    def forward(self, hidden_states, temb=None, camera_emb=None, encoder_hidden_states=None):
        output_states = ()
...
class CrossAttnUpBlock3D(nn.Module):
    def __init__(
        ...
        for i in range(num_layers): # UpBlock有3层*(Resnet + Transformer3DModel)
