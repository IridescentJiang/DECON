...
def main():
    ...
    parser.add_argument('--name',type=str, default="sv3d") # mv下的实验子目录
    ...
    for subject in tqdm(subjects):
        pr_sub_dir = os.path.join(pr_dir, subject, "gen")
...
# sv3d
# python eval_pplc_baseline.py --pr /apdcephfs_cq10/share_1330077/hexu/NVS/0_nvs_baseline_test/sv3d --dataset thuman --name sv3d --step 1
# python eval_pplc_baseline.py --pr /apdcephfs_cq10/share_1330077/hexu/NVS/0_nvs_baseline_test/sv3d --dataset customhumans --name sv3d --step 1
# python eval_pplc_baseline.py --pr /apdcephfs_cq10/share_1330077/hexu/NVS/0_nvs_baseline_test/sv3d --dataset thuman --name sv3d --step 2
# python eval_pplc_baseline.py --pr /apdcephfs_cq10/share_1330077/hexu/NVS/0_nvs_baseline_test/sv3d --dataset customhumans --name sv3d --step 2

# zero123 未完成！！！
# python eval_pplc_ours.py --pr /apdcephfs_cq10/share_1330077/hexu/NVS/test_set --dataset thuman --name gt_gen/nvs_dual_branch@step2_union_v1
# python eval_pplc_ours.py --pr /apdcephfs_cq10/share_1330077/hexu/NVS/test_set --dataset customhumans --name gt_gen/nvs_dual_branch@step2_union_v1
