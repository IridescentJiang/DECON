...
#     ms.save_current_mesh("./tmp/remesh.obj")
#     polished_mesh = trimesh.load_mesh("./tmp/remesh.obj")
...
#     # colors_pr = torch.tensor(polished_mesh.visual.vertex_colors).float().unsqueeze(0).to(device)
